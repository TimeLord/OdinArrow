...
foreign libparquet_capi {
	parquet_capi_from_csv_mem :: proc(
		input_path:      cstring,
		output_path:     cstring,
...
main :: proc() {
	...
	if in_path == "" || out_path == "" {
		fmt.eprintln("usage: csv_to_parquet_ffi [-m MB] <input.csv> <output.parquet>")
